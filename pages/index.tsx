    ...
    <>
      ...
      <main className="min-h-screen bg-white text-black p-8 max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-blue-700 mb-6">I&apos;m a software engineer with a passion for building clean, efficient, and user-friendly web applications. My experience in both frontend and backend development allows me to bring ideas to life — whether it&apos;s a data-driven sports analytics tool or a full-stack web app.

I specialize in Java, Python, JavaScript/TypeScript, and modern frameworks like React, Next.js, Spring Boot, .NET, and always open to learning new languages and technologies. I&apos;m currently exploring the intersection of software, sports, and machine learning to create engaging digital experiences.
